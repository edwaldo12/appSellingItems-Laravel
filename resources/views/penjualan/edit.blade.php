                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="nama_pelanggan" id="nama_pelanggan" class="form-control {{ $errors->has('nama_pelanggan') ? 'is-invalid' : '' }}">
                                        @foreach ($pelanggan as $pelanggan)
                                        <option value="{{ $pelanggan->id }}" {{ old('nama') == $pelanggan->nama ? 'selected' : '' }}>
                                            {{ $pelanggan->nama }}
                                        </option>
                                        @endforeach
                                    </select>
        ...
        $(function() {
            ...
            for (let i = 0; i < penjualanOrder.length; i++) {
                penjualan += "<tr>" +
                    ...
                    "<td>" + formatRupiah(String(penjualanOrder[i].barang.harga)) + "</td>" +
                    "<td>" + penjualanOrder[i].jumlah + "</td>" +
                    "<td>" + formatRupiah(String(penjualanOrder[i].jumlah * penjualanOrder[i].barang.harga)) + "</td>" +
                    "<td>" +
