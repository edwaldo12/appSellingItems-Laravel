            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Ubah Kontainer</h3>
                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('suhu_sesudah_loading') ? 'has-error' : '' }}">
                                        ...
                                        <input type="number" class="form-control" name="suhu_sesudah_loading"
                                            id="suhu_sesudah_loading"
                                            value="{{ old('suhu_sesudah_loading') ? old('suhu_sesudah_loading') : $container->suhu_sesudah_loading }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('no_seal_container') ? 'has-error' : '' }}">
                                        ...
                                        <input type="number" class="form-control" name="no_seal_container"
                                            id="no_seal_container"
                                            value="{{ old('no_seal_container') ? old('no_seal_container') : $container->no_seal_container }}"
                                    ...
                                    <div
                                        ...
                                        <input type="number" class="form-control" name="suhu_sebelum_loading"
                                            id="suhu_sebelum_loading"
                                            value="{{ old('suhu_sebelum_loading') ? old('suhu_sebelum_loading') : $container->suhu_sebelum_loading }}"
                                    ...
                                    <div class="form-group {{ $errors->has('kondisi_fisik') ? 'has-error' : '' }}">
                                        ...
                                        <select name="kondisi_fisik" id="kondisi_fisik" class="form-control" required>
                                            @if (old('kondisi_fisik'))
                                                <option value="baik"
                                                    {{ old('kondisi_fisik') == 'baik' ? 'selected' : '' }}>
                                                    baik
                                                </option>
                                                <option value="tidak"
                                                    {{ old('kondisi_fisik') == 'tidak' ? 'selected' : '' }}>
                                                    tidak
                                                </option>
                                            @else
                                                <option value="baik"
                                                    {{ $container->kondisi_fisik == 'baik' ? 'selected' : '' }}>
                                                    baik
                                                </option>
                                                <option value="tidak"
                                                    {{ $container->kondisi_fisik == 'tidak' ? 'selected' : '' }}>
                                                    tidak
                                                </option>
                                            @endif
                                        </select>
